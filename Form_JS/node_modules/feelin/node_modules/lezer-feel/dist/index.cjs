...
const feelHighlighting = highlight.styleTags({
  ...
  'Name QualifiedName': highlight.tags.name,
  'CompareOp': highlight.tags.compareOperator,
  'ArithOp': highlight.tags.arithmeticOperator,
  'PropertyName PathExpression/Name Key': highlight.tags.propertyName,
  'for if then else some every satisfies between': highlight.tags.controlKeyword,
  'in return instance of and or': highlight.tags.operatorKeyword,
  'function': highlight.tags.definitionKeyword,
  'FormalParameter/Type!': highlight.tags.typeName,
  ...
  'ParameterName VariableName ?': highlight.tags.variableName,
  'DateTimeConstructor! SpecialFunctionName BuiltInFunctionName': highlight.tags.function(highlight.tags.special(highlight.tags.variableName)),
  'FunctionInvocation/VariableName': highlight.tags.function(highlight.tags.variableName),
  'List Interval': highlight.tags.list,
  'BuiltInType ListType ContextType FunctionType': highlight.tags.function(highlight.tags.typeName),
  'Context': highlight.tags.definition(highlight.tags.literal),
  'ContextEntry/Key': highlight.tags.variableName,
  'InExpression/Name': highlight.tags.local(highlight.tags.variableName),
  'ParameterName/Name': highlight.tags.local(highlight.tags.variableName),
  'IterationContext/".." Interval/".." "."': highlight.tags.punctuation
});
