/*!
 * dmn-js - dmn-navigated-viewer v14.1.5
 *
...
(function (global, factory) {
   ...
   */
  EventBus$2.prototype.on = function (events, priority, callback, that) {
    ...
    if (that) {
      ...
      // callback
      actualCallback[FN_REF$2] = callback[FN_REF$2] || callback;
    }
    var self = this;
   ...
   * @param {any} [that] callback context
   */
  EventBus$2.prototype.once = function (events, priority, callback, that) {
    var self = this;
    if (isFunction$2(priority)) {
      that = callback;
      callback = priority;
    ...
    // bound callbacks via {@link #off} using the original
    // callback
    wrappedCallback[FN_REF$2] = callback;
   ...
   */
  EventBus$2.prototype.off = function (events, callback) {
    events = isArray$5(events) ? events : [events];
    var self = this;
   ...
   */
  EventBus$2.prototype.createEvent = function (data) {
    var event = new InternalEvent$2();
    event.init(data);
    return event;
  };
   ...
   */
  EventBus$2.prototype.fire = function (type, data) {
    var event, firstListener, returnValue, args;
    args = slice$3.call(arguments);
    ...
    if (data instanceof InternalEvent$2) {
   ...
   */
  EventBus$2.prototype.handleError = function (error) {
    return this.fire('error', {
      error: error
    }) === false;
  };
  EventBus$2.prototype._destroy = function () {
    this._listeners = {};
  };
   ...
   * @return {any}
   */
  EventBus$2.prototype._invokeListeners = function (event, args, listener) {
    var returnValue;
    while (listener) {
   ...
   * @return {any}
   */
  EventBus$2.prototype._invokeListener = function (event, args, listener) {
    var returnValue;
    ...
    try {
      ...
      returnValue = invokeFunction$2(listener.callback, args);
   ...
   * @param {EventBusListener} listener
   */
  EventBus$2.prototype._addListener = function (event, newListener) {
   ...
   */
  EventBus$2.prototype._getListeners = function (name) {
   ...
   * @param {EventBusListener} listener
   */
  EventBus$2.prototype._setListeners = function (name, listener) {
    this._listeners[name] = listener;
  };
  EventBus$2.prototype._removeListener = function (event, callback) {
    var listener = this._getListeners(event),
      nextListener,
      previousListener,
      listenerCallback;
    ...
    while (listener) {
      ...
      if (listenerCallback === callback || listenerCallback[FN_REF$2] === callback) {
        if (previousListener) {
   ...
   */
  function InternalEvent$2() {}
  InternalEvent$2.prototype.stopPropagation = function () {
    this.cancelBubble = true;
  };
  InternalEvent$2.prototype.preventDefault = function () {
    this.defaultPrevented = true;
  };
  InternalEvent$2.prototype.init = function (data) {
    assign$4(this, data || {});
  };
   ...
   * @return {any}
   */
  function invokeFunction$2(fn, args) {
  ...
  function set$1(element, svg) {
    ...
    var nodes = slice$2(parsed.childNodes);
  ...
  *
  ...
  Viewer$4.prototype._modules = [CoreModule$1, TranslateModule$2, SelectionModule, OverlaysModule, DefinitionPropertiesModule, DrillDownModule];
  ...
  var Viewer$3 = /*#__PURE__*/function (_Table) {
    ...
    _createClass(Viewer, [{
      ...
      value: function _getModules() {
        return [annotationsModule, coreModule, TranslateModule$1, decisionTableHeadModule, decisionTablePropertiesModule, decisionRuleIndicesModule, decisionRulesModule, hitPolicyModule, viewDrdModule];
      }
    }, {
