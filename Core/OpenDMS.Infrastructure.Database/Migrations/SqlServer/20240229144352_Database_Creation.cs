        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ERP = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    AOO = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    RootOrganizationNode = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CountryCode = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                    LicTradNum = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    FiscalCode = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    IPACode = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    Avatar = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Sex = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    SurName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FirstName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    LastUpdateUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateErrors = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Annotation = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CounterId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPageId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    HeaderPageId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Icon = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Title = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ToolTip = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    IncludeSubMenus = table.Column<bool>(type: "bit", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndPointDescriptor = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ObjectId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessKey = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Driver = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Provider = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Connection = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnWidth = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeputyUserId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Details = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EventType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    WorkflowId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    TaskId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalPath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    FileManager = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FileNameHash = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    FileExtension = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    CheckOutUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PreservationUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PreservationPDV = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PreservationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SignatureSession = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SignatureUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SignatureDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Signatures = table.Column<int>(type: "int", nullable: false),
                    SendingUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SendingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SendingIdentifier = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DeletionUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UIDL = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    MessageId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    MessageUID = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    InternalMailAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MessageDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExternalMailAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MessageTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    IMAPFolder = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    IsSPAM = table.Column<bool>(type: "bit", nullable: false),
                    IsInfected = table.Column<bool>(type: "bit", nullable: false),
                    WorkerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    LastRunningUpdate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArchivingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PurgedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DocumentId = table.Column<int>(type: "int", nullable: false),
                    ProtocolNumber = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ProtocolURL = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ClaimUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ClaimDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletionUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ArchivingUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    MailboxId = table.Column<int>(type: "int", nullable: false),
                    ExternalMailAddressCC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExternalMailAddressCCr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LinkAttachments = table.Column<bool>(type: "bit", nullable: false),
                    IncludePDFPreview = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InboxServer = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    InboxServerPort = table.Column<int>(type: "int", nullable: false),
                    InboxSSL = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    SMTPServerSSL = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalApp = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    FromUserId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    TaskType = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PriorityId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FormKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    NotifyExecution = table.Column<bool>(type: "bit", nullable: false),
                    NotifyExpiration = table.Column<bool>(type: "bit", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MessageTemplate = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    JobInstanceId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ProcessInstanceId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LanguageId = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemFilter = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SerializedFilters = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ClosingUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ExternalId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ExternalApp = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    NotificationStrategy = table.Column<int>(type: "int", nullable: false),
                    NotificationProfile = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ACLId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ProfileId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Icon = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    IconColor = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    InitialStatus = table.Column<int>(type: "int", nullable: false),
                    Internal = table.Column<bool>(type: "bit", nullable: false),
                    ToBeSigned = table.Column<bool>(type: "bit", nullable: false),
                    ToBePublished = table.Column<bool>(type: "bit", nullable: false),
                    ToBePreserved = table.Column<bool>(type: "bit", nullable: false),
                    ToBeIndexed = table.Column<bool>(type: "bit", nullable: false),
                    AcceptedExtensions = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    MaxVersions = table.Column<int>(type: "int", nullable: false),
                    FileNamingTemplate = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ACLId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FileManager = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PersonalData = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    DescriptionLabel = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DocumentDateLabel = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DocumentNumberLabel = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DocumentNumberDataType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    DetailPage = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    DocumentNumberMandatory = table.Column<bool>(type: "bit", nullable: false),
                    DescriptionMandatory = table.Column<bool>(type: "bit", nullable: false),
                    ConvertToPDF = table.Column<bool>(type: "bit", nullable: false),
                    Direction = table.Column<int>(type: "int", nullable: false),
                    CreationFormKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CAP = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    SearchName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CreationUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    LastUpdateUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    EndpointId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsCustom = table.Column<bool>(type: "bit", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    CustomTaskEndpointEndpoint = table.Column<string>(type: "nvarchar(255)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EntryId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ProfileType = table.Column<int>(type: "int", nullable: false),
                    CC = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCredentialUpdate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    LastSendingError = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastSendingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastReceivingError = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastReceivingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReadOnlyProfiles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SendEnabledProfiles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DraftEnabledProfiles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnableDownload = table.Column<bool>(type: "bit", nullable: false),
                    DeleteDownloadedMail = table.Column<bool>(type: "bit", nullable: false),
                    DownloadImapFolders = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SaveToImapFolder = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirstReceivingMessageDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DaysToRead = table.Column<int>(type: "int", nullable: false),
                    GracePeriod = table.Column<int>(type: "int", nullable: false),
                    EmptyTrash = table.Column<bool>(type: "bit", nullable: false),
                    LastDeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReaderWorkerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SenderWorkerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    EraserWorkerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    NextReaderDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NextSenderDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NextEraserDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IdleTime = table.Column<int>(type: "int", nullable: false),
                    DocumentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SaveAsDocument = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ClaimDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FirstExecutionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserGroupId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ParentUserGroupId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    TaskReallocationProfile = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentFormattedNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    DocumentNumberDataType = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    Referents = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferentsCC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConsolidationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ACLId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Reserved = table.Column<bool>(type: "bit", nullable: false),
                    PersonalData = table.Column<bool>(type: "bit", nullable: false),
                    Owner = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ProtocolNumber = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ProtocolImageId = table.Column<int>(type: "int", nullable: false),
                    ExternalProtocolUid = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ExternalProtocolURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ProtocolCustomProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProtocolUser = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Width = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                    Mandatory = table.Column<bool>(type: "bit", nullable: false),
                    Editable = table.Column<bool>(type: "bit", nullable: false),
                    Tag = table.Column<bool>(type: "bit", nullable: false),
                    Preservable = table.Column<bool>(type: "bit", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    LastUpdateUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Encrypted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthenticationType = table.Column<int>(type: "int", nullable: false),
                    JobWorker = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    InputVariables = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OutputVariables = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TaskGroupId = table.Column<string>(type: "nvarchar(64)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentTypeId = table.Column<string>(type: "nvarchar(64)", nullable: true),
                    FieldName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    FieldTypeId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Value = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    FormattedValue = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LookupValue = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Encrypted = table.Column<bool>(type: "bit", nullable: false),
                    Customized = table.Column<bool>(type: "bit", nullable: false),
                    Internal = table.Column<bool>(type: "bit", nullable: false),
                    Tag = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    DocumentId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<string>(type: "nvarchar(129)", maxLength: 129, nullable: false),
                    ProfileType = table.Column<int>(type: "int", nullable: false),
                    PermissionId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Authorization = table.Column<int>(type: "int", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ProfileType = table.Column<int>(type: "int", nullable: false),
                    InitialProfileId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdateUser = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "$ACCOUNTING$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7794), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7794), "Contabilità" },
                    { "$GLOBAL$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7493), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7498), "Permessi Globali" },
                    { "$HR$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7822), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7822), "Personale" },
                    { "$MAIL$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7828), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7829), "Corrispondenza" },
                    { "$MANAGEMENT$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7801), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7801), "Amministrazione" },
                    { "$PROTOCOL$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7787), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7788), "Protocollo" },
                    { "$PURCHASE$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7815), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7816), "Acquisti" },
                    { "$SALES$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7807), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7808), "Vendite" },
                    { "$WORKFLOW$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7830), "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7831), "Workflow" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "00000000-0000-0000-0000-000000000000", null, null, 1, null, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7237), null, false, null, null, "Utente di Sistema", "Utente di Sistema", null, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7237), null, null, null, "Utente di Sistema", null, null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "$service$", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7215), false, null, "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7215), "Servizio Applicativo" },
                    { "admin", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7198), false, null, "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7201), "Amministratore" },
                    { "user", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7227), false, null, "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7228), "Utente Interattivo" },
                    { "workflow_architect", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7222), false, null, "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7222), "Progettista di Workflow" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "$GLOBAL$", "ACL.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7699), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7699) },
                    { "$GLOBAL$", "Company.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7710), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7710) },
                    { "$GLOBAL$", "Datasource.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7715), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7715) },
                    { "$GLOBAL$", "Document.AddContent", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7558), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7558) },
                    { "$GLOBAL$", "Document.Authorize", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7552), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7553) },
                    { "$GLOBAL$", "Document.Create", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7534), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7534) },
                    { "$GLOBAL$", "Document.Delete", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7546), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7546) },
                    { "$GLOBAL$", "Document.Edit", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7539), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7540) },
                    { "$GLOBAL$", "Document.Execute", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7610), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7610) },
                    { "$GLOBAL$", "Document.History", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7599), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7600) },
                    { "$GLOBAL$", "Document.RemoveContent", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7564), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7564) },
                    { "$GLOBAL$", "Document.Share", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7569), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7569) },
                    { "$GLOBAL$", "Document.View", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7521), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7521) },
                    { "$GLOBAL$", "Document.ViewContent", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7529), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7529) },
                    { "$GLOBAL$", "DocumentType.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7693), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7693) },
                    { "$GLOBAL$", "Mail.Console", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7736), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7737) },
                    { "$GLOBAL$", "MailServer.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7725), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7725) },
                    { "$GLOBAL$", "Meta.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7704), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7705) },
                    { "$GLOBAL$", "Profile.CanCeateRootFolder", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7625), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7626) },
                    { "$GLOBAL$", "Profile.CanHavePersonalFolder", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7620), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7621) },
                    { "$GLOBAL$", "Profile.Client", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7781), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7781) },
                    { "$GLOBAL$", "Profile.CreateGenericDocument", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7605), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7605) },
                    { "$GLOBAL$", "Profile.RemoteSignatureService", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7776), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7776) },
                    { "$GLOBAL$", "Profile.SendMail", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7741), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7742) },
                    { "$GLOBAL$", "Profile.Signature", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7770), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7771) },
                    { "$GLOBAL$", "Roles.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7688), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7688) },
                    { "$GLOBAL$", "Tables.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7720), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7721) },
                    { "$GLOBAL$", "Task.Create", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7670), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7670) },
                    { "$GLOBAL$", "Task.CreateMessage", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7676), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7676) },
                    { "$GLOBAL$", "Task.View", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7664), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7664) },
                    { "$GLOBAL$", "Team.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7682), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7682) },
                    { "$GLOBAL$", "Team.ReadInbox", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7652), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7653) },
                    { "$GLOBAL$", "Team.ReadInboxCC", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7658), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7659) },
                    { "$GLOBAL$", "Team.ViewDown", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7637), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7637) },
                    { "$GLOBAL$", "Team.ViewSide", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7647), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7647) },
                    { "$GLOBAL$", "Team.ViewUp", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7631), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7632) },
                    { "$GLOBAL$", "Template.Admin", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7730), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7731) },
                    { "$GLOBAL$", "Workflow.Dashboard", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7615), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7615) },
                    { "$WORKFLOW$", "Document.Create", "admin", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7848), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7848) },
                    { "$WORKFLOW$", "Document.Create", "workflow_architect", 2, 1, new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7841), new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7841) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "$system$", "00000000-0000-0000-0000-000000000000", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7264), false, null, "", new DateTime(2024, 2, 29, 14, 43, 51, 895, DateTimeKind.Utc).AddTicks(7265) });
