...
namespace Core.DigitalSignature.Pkcs11
{
    ...
    public static class CertUtils
    {
        ...
        public static ICollection<BCX509.X509Certificate> BuildCertPath(X509Certificate2 signingCertificate, List<byte[]> otherCertificates, bool includeRoot)
        {
...
//                if (trustAnchors.Count < 1)
                ...
                if (trustAnchors.Count > 0)
                {
                    ...
                    //foreach (var oc in otherCerts)
                        //certPathBuilderParameters.AddStore(Org.BouncyCastle.Utilities.Collections.CollectionUtilities.CreateStore(otherCerts));
                    ...
                    //var certStore = Org.BouncyCastle.X509.Store.X509CertStoreSelector  X509StoreFactory.Create("Certificate/Collection", new X509CollectionStoreParameters(otherCerts));
                    //certPathBuilderParameters.add.set..SetStoresCert(certStore);
