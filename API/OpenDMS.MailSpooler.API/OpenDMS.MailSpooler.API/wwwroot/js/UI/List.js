    ...
    $.widget("elmi.List", $.extend({}, {
        ...
        _init: function () {
            ...
            if (this.options.textField) {
                ...
                var $item = $li;
                var $a = $("<a href='#' data-bind='visible:  " + that.options.idField + "() !=\"-\",  click: $root." + c + ", attr: { itemid: " + (this.options.idField) + " }'" + (this.options.commentField ? "style='height:36px'" : '')+"></a>").appendTo($item);
