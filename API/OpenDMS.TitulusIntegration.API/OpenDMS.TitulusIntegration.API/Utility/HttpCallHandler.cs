...
namespace OpenDMS.TitulusIntegration.API.Utility
{
    ...
    /// </summary>
    public class HttpCallHandlerV2 
    {
        private readonly IHttpContextAccessor httpContextAccessor;
        public HttpCallHandlerV2(IHttpContextAccessor httpContextAccessor = null)
        {
    ...
    public class HttpCallException : Exception
    {
        ...
        public HttpCallException(HttpStatusCode? code, String? statusMessage)
        {
            ...
            if (code == System.Net.HttpStatusCode.Unauthorized)
                this.StatusMessage = "Accesso non autorizzato";
            else
