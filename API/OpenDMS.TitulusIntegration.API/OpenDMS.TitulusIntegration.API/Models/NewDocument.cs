...
namespace OpenDMS.TitulusIntegration.API.Models
{
    ...
    public class InboundDocument
    {
        ...
        public string classifica { set; get; }

        public string rif_esterno_dataprot { set; get; }
        public string rif_esterno_numprot { set; get; }

        public string rif_interno_rpa { set; get; }
        public string rif_interni_cc { set; get; }

        public string rif_esterno_rpa { set; get; }
        public string rif_esterni_cc { set; get; }
