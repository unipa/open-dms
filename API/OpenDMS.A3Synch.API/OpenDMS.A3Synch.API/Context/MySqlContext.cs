...
namespace A3Synch.Context
{
    public class MySqlContext : DbContext, IContext
    {
        ...
        public MySqlContext(DbContextOptions<MySqlContext> options, IConfiguration config)
            : base(options)
        {
            _config = config;
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySQL(connectionString, b => b.MigrationsAssembly("MySql.EntityFrameworkCore"));
