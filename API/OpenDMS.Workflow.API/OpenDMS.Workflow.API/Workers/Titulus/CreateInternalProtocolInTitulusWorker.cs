...
{
    public class CreateInternalProtocolInTitulusWorker : BaseWorker
    {
        ...
        public override string JobType { get; set; } = "CreateInternalProtocolInTitulus";
        public override string TaskLabel { get; set; } = "Crea un nuovo protocollo interno su Titulus";
        public override string Icon { get; set; } = "fa-regular fa-building-o";
        public override string GroupName { get; set; } = "Titulus";
        public override string[] AlternativeTasks { get; set; } = { };

        public override string Inputs { get; set; } = "debug,documentId,bozza,Oggetto,Tipologia,Note, MezzoTrasmissione, MezzoTrasmissioneValuta, MezzoTrasmissioneCosto VoceIndice, PersoneaInterna, PersoneEsterneCC, PersoneEsterne, Attachments";
        ...
        public CreateInternalProtocolInTitulusWorker(
            ILogger<CreateInternalProtocolInTitulusWorker> logger,
        ...
        public override async Task<string> Execute(IJob job)
        {
            ...
            var list2 = jsonObject["PersoneEsterne"]?.ToObject<string>() ?? "";
            var list3 = jsonObject["PersoneEsterneCC"]?.ToObject<string>() ?? "";
            var list4 = jsonObject["StruttureInterne"]?.ToObject<string>() ?? "";
            var list5 = jsonObject["StruttureInterneCC"]?.ToObject<string>() ?? "";

            document.PersonaInterna = "" + (string)jsonObject["PersonaInterna"]; 
            document.PersoneEsterne = list2.Split(",", StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries).ToList(); 
            document.PersoneEsterneCC = list3.Split(",", StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries).ToList(); 

            document.StruttureInterne = list4.Split(",", StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries).ToList(); 
            document.StruttureInterneCC = list5.Split(",", StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries).ToList(); 
            ...
            var response = TitulusService.SaveInternalProtocol(document, bozza);
            if (response != null)
            {
