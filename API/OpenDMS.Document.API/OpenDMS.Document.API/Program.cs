...
namespace OpenDMS.DocumentManager.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Logging.AddLogging("DocumentManager.API", seqUrl);
            ...
            builder.Services.AddTransient<IFileConvertFactory, FileConvertFactory>();
            ...
            builder.Services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "OpenDMS.DocumentManager.API",
                    Description = "Servizio per la gestione dei documenti di un Tenant",
            ...
            builder.Services.AddAuthorization(
                       //o => o.AddPolicy("user", b => b.RequireClaim("roles", "admin").RequireAuthenticatedUser())
                   );
            ...
            app.UseSwagger(c =>
            {
                c.RouteTemplate = "/api/document/swagger/{documentName}/swagger.json";
            });
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/api/document/swagger/v1/swagger.json", "OpenDMS.Admin.API V1");
                c.RoutePrefix = "api/document/swagger";
            });
