/*! bpmn-js - bpmn-navigated-viewer v16.3.2 | Copyright (c) 2014-present, camunda Services GmbH | bpmn.io/license */
...
/**
   ...
   */(i)); n = k(r, "bpmn:Collaboration") ? r : u(e.rootElements, (function (e) { if (k(e, "bpmn:Collaboration")) return u(e.participants, (function (e) { return e.processRef === r })) })); var o = [r]; n && (o = function (e, t) { let n = []; return f(e, (function (e, i) { n.push(t(e, i)) })), n }(n.participants, (function (e) { return e.processRef }))).push(n); var a = Dr(o), s = [t], l = [i]; return f(e.diagrams, (function (e) { var t = e.plane.bpmnElement; -1 !== a.indexOf(t) && -1 === l.indexOf(t) && (s.push(e), l.push(t)) })), s
            }(e, t); if (!r) throw new Error(o("no diagram to display")); f(r, (function (t) { n.handleDefinitions(e, t) })); var l = t.plane.bpmnElement.id; a.setRootElement(a.findRoot(l + "_plane") || a.findRoot(l))
        } return new Promise((function (p, c) { try { return i = e.get("bpmnImporter"), r = e.get("eventBus"), o = e.get("translate"), a = e.get("canvas"), r.fire("import.render.start", { definitions: t }), l(t, n), r.fire("import.render.complete", { error: undefined, warnings: s }), p({ warnings: s }) } catch (e) { return e.warnings = s, c(e) } }))
    } function Dr(e) { var t = []; return f(e, (function (e) { e && (t.push(e), t = t.concat(Dr(e.flowElements))) })), t } var Br, Lr = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.02 5.57" width="53" height="21"><path fill="currentColor" d="M1.88.92v.14c0 .41-.13.68-.4.8.33.14.46.44.46.86v.33c0 .61-.33.95-.95.95H0V0h.95c.65 0 .93.3.93.92zM.63.57v1.06h.24c.24 0 .38-.1.38-.43V.98c0-.28-.1-.4-.32-.4zm0 1.63v1.22h.36c.2 0 .32-.1.32-.39v-.35c0-.37-.12-.48-.4-.48H.63zM4.18.99v.52c0 .64-.31.98-.94.98h-.3V4h-.62V0h.92c.63 0 .94.35.94.99zM2.94.57v1.35h.3c.2 0 .3-.09.3-.37v-.6c0-.29-.1-.38-.3-.38h-.3zm2.89 2.27L6.25 0h.88v4h-.6V1.12L6.1 3.99h-.6l-.46-2.82v2.82h-.55V0h.87zM8.14 1.1V4h-.56V0h.79L9 2.4V0h.56v4h-.64zm2.49 2.29v.6h-.6v-.6zM12.12 1c0-.63.33-1 .95-1 .61 0 .95.37.95 1v2.04c0 .64-.34 1-.95 1-.62 0-.95-.37-.95-1zm.62 2.08c0 .28.13.39.33.39s.32-.1.32-.4V.98c0-.29-.12-.4-.32-.4s-.33.11-.33.4z"/><path fill="currentColor" d="M0 4.53h14.02v1.04H0zM11.08 0h.63v.62h-.63zm.63 4V1h-.63v2.98z"/></svg>', Ir = { verticalAlign: "middle" }, jr = { color: "#404040" }, Fr = { zIndex: "1001", position: "fixed", top: "0", left: "0", right: "0", bottom: "0" }, Vr = { width: "100%", height: "100%", background: "rgba(40,40,40,0.2)" }, Wr = { position: "absolute", left: "50%", top: "40%", transform: "translate(-50%)", width: "260px", padding: "10px", background: "white", boxShadow: "0 1px 4px rgba(0,0,0,0.3)", fontFamily: "Helvetica, Arial, sans-serif", fontSize: "14px", display: "flex", lineHeight: "1.3" }, zr = '<div class="bjs-powered-by-lightbox"><div class="backdrop"></div><div class="notice"><a href="https://bpmn.io" target="_blank" rel="noopener" class="link">' + Lr + '</a><span>Web-based tooling for BPMN, DMN and forms powered by <a href="https://bpmn.io" target="_blank" rel="noopener">bpmn.io</a>.</span></div></div>'; function $r() { Br || (Te(Br = Ze(zr), Fr), Te(Je("svg", Br), Ir), Te(Je(".backdrop", Br), Vr), Te(Je(".notice", Br), Wr), Te(Je(".link", Br), jr, { margin: "15px 20px 15px 10px", alignSelf: "center" }), Ue.bind(Br, ".backdrop", "click", (function (e) { document.body.removeChild(Br) }))), document.body.appendChild(Br) }
/**
   ...
   * @see http://bpmn.io/license for more information.
   */function Gr(e) {
        e = E({}, Kr, e), this._moddle = this._createModdle(e), this._container = this._createContainer(e),
        /**
