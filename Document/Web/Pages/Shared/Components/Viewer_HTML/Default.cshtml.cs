...
namespace Web.Pages.Shared.Components.Viewer_HTML
{
    public class Viewer_HTML : ViewComponent
    {
        ...
        public Viewer_HTML(IDocumentService documentService,
        ...
        {
            byte[] byteData = sr.Document.Image != null ? await documentService.GetContent(sr.Document.Image.Id) : new byte[0];
