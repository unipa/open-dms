...
{
    [Authorize]
    public class DetailsProcessModel : PageModel
    {
        private readonly ILogger<DetailsProcessModel> _logger;
        ...
        public DetailsProcessModel(ILogger<DetailsProcessModel> logger,
