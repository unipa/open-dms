...
{
    [Authorize]
    public class DetailsTemplateModel : PageModel
    {
        private readonly ILogger<DetailsTemplateModel> _logger;
        ...
        public DetailsTemplateModel(ILogger<DetailsTemplateModel> logger,
        ...
        public async Task<IActionResult> OnGet(int? id)
        {
            ...
            if (DocumentId <= 0)
            {
                ...
                if (string.IsNullOrEmpty(home)) home = "Folders/Index";
            ...
            CanEdit =  (u.Roles.Select(s => s.Id).Contains("admin") || (await documentService.GetPermission(DocumentId, u, PermissionType.CanEdit)).Authorization == OpenDMS.Domain.Enumerators.AuthorizationType.Granted);
            CanDelete = (u.Roles.Select(s => s.Id).Contains("admin") || (await documentService.GetPermission(DocumentId, u, PermissionType.CanDelete)).Authorization == OpenDMS.Domain.Enumerators.AuthorizationType.Granted);
...
//                CanSign = !String.IsNullOrEmpty(remoteSignurl + otpserviceurl + feaserviceurl) || HasSignature;
            ...
            FileFilters = await ControllerUtility.GetFilters(Request, "Documenti nel fascicolo", Document.DocumentType);
