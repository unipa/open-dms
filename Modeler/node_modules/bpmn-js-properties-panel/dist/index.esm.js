...
import elements from '../../../app/descriptors/customelements.json'
...
//qui inseriamo icona per il custom task
// function _extends$lo() { _extends$lo = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends$lo.apply(this, arguments); }
// var userMessageTask = (({
//   styles = {},
//   ...props
// }) => /*#__PURE__*/React.createElement("svg", _extends$lo({
//   xmlns: "http://www.w3.org/2000/svg",
//   width: "32",
//   height: "32"
// }, props), /*#__PURE__*/React.createElement("path", {
...
const __extends = Object.assign;

function createSvgIcon(path) {
  return function SvgIcon({ styles = {}, ...props }) {
    return /*#__PURE__*/React.createElement("svg", __extends({
      xmlns: "http://www.w3.org/2000/svg",
      width: "32",
      height: "32"
    }, props), /*#__PURE__*/React.createElement("path", { d: path }));
  }
}

// elements.forEach(group => {
//   group.items.forEach(item => {
//     if (!iconsByType.hasOwnProperty(item.actionName)) {
//       iconsByType[item.actionName] = createSvgIcon("M6.494 2.667C2.916 2.667 0 5.57 0 9.142v13.383C0 26.097 2.916 29 6.494 29h19.012C29.084 29 32 26.097 32 22.525V9.142c0-3.572-2.916-6.475-6.494-6.475H6.494zm0 2h19.012c2.509 0 4.494 1.98 4.494 4.475v13.383C30 25.02 28.015 27 25.506 27H6.494C3.985 27 2 25.02 2 22.525V9.142c0-2.495 1.985-4.475 4.494-4.475z");
//     }
//   });
// });

// console.log(iconsByType);
...
function updateEscalationGroup$1(groups, element) {
  ...
  escalationGroup.entries = overrideGenericEntries(escalationGroup.entries, EscalationProps$1({
    element
  }));
}
